...
void generateMakefileFromProject(const std::string& fileToSave, const Project& project, const bool absolutePaths)
{
	...
	make.listVariableWithPrefix("CPP_INCLUDE_PATHS", "-I", project.getIncludePaths(absolutePaths));

	make.listVariableWithPrefix("CPP_LIBRARY_PATHS", "-L", project.getLibraryPaths(absolutePaths));
	make.listVariableWithPrefix("CPP_LIBRARIES", "-l", project.getLibraries());
